...
peep_listFiles = ['182_left_peep_1_series','182_left_peep_2_series','188_right_peep_1_series',
                  ...
                  '01R-旁窥_series', 'suda_left_peep_1_series.npy', 'suda_left_peep_2_series.npy', 
                  'suda_right_peep_1_series.npy', 'suda_right_peep_2_series.npy'] # 12
...
back_listFiles = ['182_left_back_1_series','182_left_back_2_series','188_right_back_1_series',
                  ...
                  '02R-回头1_series','02R-回头2_series','02R-回头1115_series', 'suda_left_back_1_series.npy', 
                  'suda_left_back_2_series.npy', 'suda_right_back_1_series.npy', 'suda_right_back_2_series.npy'] # 14
    ...
    def gen_onePieceData(self,series,start,end):
        ...
        for _ in range(numSamples):
            ...
            for target in range(targets):
                ...
                if target_numNonZeros >= 43:  ## 中间可能出现几帧的坐标都为0,两头也可能出现0，超过两帧目标丢失，就把此目标丢掉
...
if __name__ == '__main__':
    ...
    dataDict=dict()
    dataDict['normal']=[]
    # npy_root_path = './npy/stand'
    npy_root_path = '/root/tmp/code/baa-point-v2-train/npy/stand'
    ...
    for key in tqdm.tqdm(dataDict.keys()):
        ...
        np.save('/root/tmp/code/baa-point-v2-train/out/' + key + '_original.npy', data_copy)  # shape: N,C,T,V
        ...
        np.save('/root/tmp/code/baa-point-v2-train/out/' + key + '_global_normalize.npy', data_with_position)  # shape: N,C,T,V
        ...
        np.save('/root/tmp/code/baa-point-v2-train/out/' + key + '_single_normalize.npy', data)  # shape: N,C,T,V
