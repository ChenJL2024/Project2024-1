...
import os
from select_validdata import _valid_passon_data,_valid_peep_data,_valid_raise_data,_valid_sit_data,_valid_stand_data, plot_target_video


peep_listFiles = ['182_left_peep_1_series','182_left_peep_2_series','188_right_peep_1_series','188_right_peep_2_series',
                  '01L-旁窥1115_series','01L-旁窥_series','01R-旁窥1115_series','01R-旁窥_series'] # suda_peep_srt_还没标

# back_listFiles = ['182_left_back_1_series','182_left_back_2_series','188_right_back_1_series','188_right_back_2_series',
#                   '02L-回头1_series','02L-回头2_series','02L-回头1115_series','02R-回头1_series','02R-回头2_series','02R-回头1115_series'] #suda_back_srt_还没有标
back_listFiles = ['02L-回头1_series','02L-回头2_series','02L-回头1115_series','02R-回头1_series','02R-回头2_series','02R-回头1115_series']
...
#                     'suda_right_passon_0_series','suda_right_passon_1_series','suda_right_passon_2_series']

passon_listFiles = ['03L-传递纸条_series']
...
raise_listFiles = ['182_left_raise_1_series','182_left_raise_2_series','182_left_raise_3_series','182_left_raise_4_series',
                   ...
                   'suda_right_raise_1_series','suda_right_raise_2_series','suda_right_raise_3_series','suda_right_raise_4_series']
...
stand_listFiles = ['suda_left_stand_1_series','suda_left_stand_2_series','suda_right_stand_1_series','suda_right_stand_2_series', 
                   ...
                   '04L_stand1_series','04L_stand2_series','04R_stand1_series','04R_stand2_series']
...
object_order = 0 # 目标计数，从第一个目标开始计数，筛选后缺少的目标直接跳过，不使用滑动窗口的操作
...
class oneSample: # 处理一个目标从头到尾的所有样本
    ...
    def getData(self, key):
        ...
        for i,timeSlot in enumerate(self.behav_timeSlot):
            ...
            dataTemp = self.gen_onePieceData(dataTemp,start,end, key)
    ...
    def gen_onePieceData(self,series,start,end, key):
        global object_order
        # series是包括正常动作的完整片段
        ...
        # os.makedirs(f'./out2/{key}', exist_ok= True)
        # npy_path = f'./out2/{key}/{object_order}.npy'
...
if __name__ == '__main__':
    ...
    dataDict['normal']=[]
    npy_root_path = './npy/passon/passon_5s/03L'
    ...
    for key in tqdm.tqdm(dataDict.keys()):
        ...
        # data = np.stack((valid_data[...,0] / 1920, valid_data[...,1] / 1080), axis= -1)

        #Save
        np.save('./out/passon_5s/' + key + '.npy', data)  # shape: N,C,T,V
