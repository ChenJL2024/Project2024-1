...
from kernel.Pose.utils.datasets import letterbox
from kernel.Pose.utils.general import non_max_suppression, non_max_suppression_export, make_divisible, scale_coords, increment_path, xyxy2xywh, save_one_box
from kernel.Pose.utils.plots import colors, plot_one_box
from kernel.Pose.utils.torch_utils import time_synchronized
...
if __name__=='__main__':
    model = TransformerBlock(3,100,1,1)
    print(model)