...
from utils.general import colorstr, check_img_size, check _requirements, file_size, set_logging
from utils.torch_utils import select_device

if __name__ == '__main__':
    #运行命令： python ./models/export.py --weights '/home/goldsun/桌面/pose_estimation/edgeai-yolov5-yolo-pose/效果较好的模型保存/左右皆可/exp_600_zuihao/weights/point_detect.pt'  --img 640 --batch 1 --simplify --export-nms --device cuda
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='/home/goldsun/桌面/pose_estimation/edgeai-yolov5-yolo-pose/效果较好的模型保存/左右皆可/exp_600_zuihao/weights/point_detect.pt', help='weights path')
