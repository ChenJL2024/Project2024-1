...
from kernel.Pose.models.common import *
from kernel.Pose.models.experimental import *
from kernel.Pose.utils.autoanchor import check_anchor_order
from kernel.Pose.utils.general import make_divisible, check_file, set_logging
from kernel.Pose.utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, \
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), nkpt=None, ch=(), inplace=True, dw_conv_kpt=False):  # detection layer
        ...
        self.no_det=(nc + 5)  # number of outputs per anchor for box and class 5：边框坐标和边框置信度
...
if __name__ == '__main__':
    ...
    # model.train()
    print(model)
    datas = torch.randn(1,3,640,640).to(device)
    print("model: ",model(datas)[0].shape)
    # Profile
