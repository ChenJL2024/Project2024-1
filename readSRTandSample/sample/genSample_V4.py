...
# listFiles = ['03L-传递纸条','03R-传递纸条']#,'03L-传递纸条1115','03R-传递纸条1115','03L-传递纸条','03R-传递纸条']
...
ceilNumSamplesPerStu = 8   #对一个学生样本所作的总采样个数上限，最小1
...
class oneSample:
    ...
    def doRandomClipAndAmpli(self, data, start, end):
        ...
        max_len = min(totalTimeLength, totalLen)
        start_valindInNew = random.randint(0, min((max_len - validLen), start))
